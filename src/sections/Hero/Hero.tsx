      ...
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="space-y-6 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start gap-4 mt-6">
            <a
              href="https://github.com/rohitpatil"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-500 transition text-2xl"
            >
              <i className="fab fa-github"></i>
            </a>
            <a
              href="https://linkedin.com/in/rohitpatil"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-500 transition text-2xl"
            >
            ...
            <a
              href="https://twitter.com/rohitpatil"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-500 transition text-2xl"
            >
