...
const DataTable = <T extends { _id?: string | number; id?: string | number }>(props: DataTableProps<T>) => {
	...
	}, [isServer, pagination && typeof pagination === 'object' ? pagination.page : 1, pagination && typeof pagination === 'object' ? pagination.limit : pageSize]);

	useEffect(() => {
		if (isServer && typeof pagination === 'object' && pagination.onSearch && searchable) {
					...
					<div className="px-4 py-3 flex items-center justify-between border-t bg-gray-50 dark:bg-gray-800">
						...
						<div className="flex items-center gap-2">
							...
							<select
								...
								className="border border-gray-300 dark:border-gray-600 rounded px-1 py-1 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
							>
