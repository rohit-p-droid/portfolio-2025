                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                    {cards.map((card) => (
                        <motion.div
                            ...
                            className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl shadow-sm hover:shadow-lg overflow-hidden group transition-all duration-200"
                        >
                            <div className="p-8">
                                ...
                                <Link
                                    to={card.link}
                                    className="inline-block bg-blue-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-600 transition-colors duration-200 group-hover:shadow-lg"
                                >
                                    {card.cta}
                                </Link>
                            </div>
