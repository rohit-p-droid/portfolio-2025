...
export const LINKEDIN_LINK = "https://www.linkedin.com/in/prohit23/";
export const EMAIL = "p.rohit.2310@gmail.com"
...
export const RESUME_LINK = "/assets/resume/Rohit Vasant Patil Resume.pdf";
...
export const SITE_URL = "https://rohitpatil.dev";
export const SITE_TITLE = "Rohit Patil Portfolio";
export const SITE_DESCRIPTION = "Portfolio of Rohit Patil - Full-stack Engineer";
